        ...
        <div className="relative pt-2">
          <div className="flex items-center gap-1">
            <button
              ...
              className="flex-1 py-3 px-4 bg-orange-500 hover:bg-orange-600 text-white font-bold uppercase text-xs font-mono tracking-wider rounded-xl shadow-lg shadow-orange-500/20 transition-all flex items-center justify-center gap-2"
            >
              <Plus size={16} />
              <span>Create</span>
            </button>
            <button
              ...
              className="py-3 px-2.5 bg-orange-500/90 hover:bg-orange-600 text-white rounded-xl transition-all"
            >
              <ChevronDown size={16} />
            </button>
          </div>
